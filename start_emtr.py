...
fig, _ = plot_flower_initial_and_final_two_gradients(tsv = "results/Aug_15_reproduction1_repetition_100_max_iter_1000_conv_thresh_0.0005.dirichlet_rooting_initial_final_rep_loglik", out = "results/Aug_15_reproduction1_repetition_100_dirichlet_flower.png", init_col="ll dirichlet", final_col="ll final", root_col="root", r_inner=0.1, r_outer=0.9, cmap_init="Blues", cmap_final="Reds")
fig, _ = plot_flower_initial_and_final_two_gradients(tsv = "results/Aug_15_reproduction1_repetition_100_max_iter_1000_conv_thresh_0.0005.pars_rooting_initial_final_rep_loglik", out = "results/Aug_15_reproduction1_repetition_100_pars_flower.png", init_col="ll pars", final_col="ll final", root_col="root", r_inner=0.1, r_outer=0.9, cmap_init="Blues", cmap_final="Reds")
fig, _ = plot_flower_initial_and_final_two_gradients(tsv = "results/Aug_15_reproduction1_repetition_100_max_iter_1000_conv_thresh_0.0005.SSH_rooting_initial_final_rep_loglik", out = "results/Aug_15_reproduction1_repetition_100_SSH_flower.png", init_col="ll SSH", final_col="ll final", root_col="root", r_inner=0.1, r_outer=0.9, cmap_init="Blues", cmap_final="Reds")
...
python3 flower_plot.py results/Aug_15_reproduction_1repetition_50_max_iter_1000_conv_thresh_0.0005.dirichlet_rooting_initial_final_rep_loglik --init-col "ll dirichlet" --final-col "ll final" --root-col "root" --out figures/Aug_14_repr_1_rep_50_dirichlet_flower.png --r-inner 0.1 --r-outer 0.8 --cmap-init "Blues" --cmap-final "Reds" --vmax-init -4360 --vmax-final -4360
python3 flower_plot.py results/Aug_15_reproduction_1repetition_50_max_iter_1000_conv_thresh_0.0005.pars_rooting_initial_final_rep_loglik --init-col "ll pars" --final-col "ll final" --root-col "root" --out figures/Aug_15_repr_1_rep_50_parsimony_flower.png --r-inner 0.1 --r-outer 0.8 --cmap-init "Blues" --cmap-final "Reds" --vmin-final -4370 --vmax-final -4363 
python3 flower_plot.py results/Aug_15_reproduction_1repetition_50_max_iter_1000_conv_thresh_0.0005.SSH_rooting_initial_final_rep_loglik --init-col "ll SSH" --final-col "ll final" --root-col "root" --out figures/Aug_14_repr_1_rep_50_ssh_flower.png --r-inner 0.1 --r-outer 0.8 --cmap-init "Blues" --cmap-final "Reds" --vmin-init -4370 --vmax-init -4363 --vmin-final -4370 --vmax-final -4363
